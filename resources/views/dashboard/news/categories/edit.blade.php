...
<div class="row m-3">
    ...
    <div class="col-xl-9 col-lg-7">
        ...
        <div class="card mb-4">
            ...
            <div class="container">
              <form action="/dashboard/news/categories/{{ $category->slug }}" method="post" enctype="multipart/form-data" class="m-3">
                @method('put')
                  @csrf
                  <div class="mb-3">
...
<script>
    ...
    name.addEventListener('change', function() {
        fetch('/dashboard/news/categories/checkSlug?name=' + name.value)
