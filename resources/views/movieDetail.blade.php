...
@section('content')
<section id="movieDetail"  style="background-image: url('/assets/img/background/bg-1.png'); background-repeat: no-repeat; background-size: cover; color: #fff">
    <div class="container">
        <div class="trailer col-12 pt-5">
            <iframe class="d-flex justify-content-center mt-5 mb-3" width="100%" height="400" src="https://www.youtube.com/embed/TcMBFSGVi1c">
            </iframe>
        </div>
        <div class="row mt-5">
            <!-- left -->
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <img src="/assets/img/avenger.jpg" class="card-img" alt="..." style="min-height: 300px">
                          </div>
                    </div>
                    <div class="col-md-8">
                        <h3 class="movie-title">Avenger End Game</h3>
                        <div class="movie-info">
                            <p>Duration: <i class="bi bi-stopwatch"></i> 02 hours 30 minutes</p>
                            <ul class="list-unstyled">
                                <li><b>Director : </b> </li>
                                <li><b>Genre :</b> Cartoon, Sci-fi</li>
                                <li><b>Release :</b> 24 April 2019</li>
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        <h3 style="border-bottom: 1px solid rgb(212, 212, 212); padding-bottom: 5px; ">Synopsis</h3>
